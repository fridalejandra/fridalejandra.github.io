...
{% include figure image_path="/images/rec_curve.png" caption="Figure 1: REC curve showing model performance across varying error thresholds." %}
...
{% include figure image_path="/images/ActualvsPredicted_Ensemble.png" caption="Figure 2: Actual vs Predicted plot for Random Forest, Ridge Regression, and Ensemble models." %}
